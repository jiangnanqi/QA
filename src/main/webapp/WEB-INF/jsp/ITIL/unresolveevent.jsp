                        ...
                        <div class="panel-body" style="display: block" id="subinfo">
                            <form method="get" class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <p class="form-control-static">${eventView.userQuestionTitle}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <p class="form-control-static">${eventView.userName}</p>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <p class="form-control-static">${eventView.userQuestionTime}</p>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
